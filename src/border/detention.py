...
def track_duration(detainee_id: str, intake_date: str = None,
    ...
    return emit_receipt("detention_duration", {
        "tenant_id": TENANT_ID,
...
def monitor_facility(facility_id: str, metrics: dict) -> dict:
    ...
    return emit_receipt("facility_monitor", {
        "tenant_id": TENANT_ID,
        "facility_id": facility_id,
        "capacity": capacity,
...
def compute_cost_per_detainee(facility_id: str, period: str,
    ...
    return emit_receipt("detention_cost", {
        "tenant_id": TENANT_ID,
        "facility_id": facility_id,
        "period": period,
